...
#define BQ769X2_DATA_BUFFER_SIZE (32)
...
#define BQ769X2_SUBCMD_OVERHEAD_BYTES (4)
...
static const uint16_t bq769x2_scd_thresholds[] = {
    10, 20, 40, 60, 80, 100, 125, 150, 175, 200, 250, 300, 350, 400, 450, 500,
}; /* mV */

/* Status register content */

union bq769x2_reg_safety_a {
    struct
    {
        uint8_t RSVD : 2;
